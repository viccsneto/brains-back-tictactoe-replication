...
description: >-
  ...
  brainsback/REACTO.md, and brainsback/SOCRATIC_REVIEW.md to enforce Mastery-Aware Pipelines. Use this when
...
Use this skill whenever you see `brainsback/TODO.md`, `brainsback/REPORT.md`, `brainsback/REACTO.md`, and `brainsback/SOCRATIC_REVIEW.md` present.
...
- `brainsback/SOCRATIC_REVIEW.md` (AI-generated, human-read-only)
  - **AI-owned**: humans must not create, edit, or pre-fill this file.
  - Triggered only after `brainsback/REACTO.md` has been reviewed and deemed appropriate by the Socratic Reviewer agent.
